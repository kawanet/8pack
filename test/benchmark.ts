    ...
    function stringTest(repeat: number, title: string, source: any) {
        ...
        describe(`${title} x ${repeat} times`, () => {
            ...
            it("(preparation)", async () => {
                ...
                data.epack = epack.encode(source);
                ...
                assert.deepEqual(epack.decode(data.epack), source);
            ...
            it("epack.encode()", test(repeat, () => epack.encode(source)));
            it("epack.decode()", test(repeat, () => epack.decode(data.epack)));
    ...
    function binaryTest(repeat: number, size: number) {
        ...
        describe(`Binary ${size} byte x ${repeat} times`, () => {
            ...
            it("(preparation)", async () => {
                ...
                check(epack.decode(data.epack = epack.encode(source)));
